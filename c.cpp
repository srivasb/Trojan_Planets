/* 
 ...
 Problema: Simular el moviminto de Dos Planeta + 
            + planeta punto de liubracion L4: 60grad.
 Planet[2]: Exoplanet
 Planet[1]: Jupyter
 Planet[0]: Sun

 m2=0.005
 v2=(vx2,vy2)=(-v*cos(60grad),v*sin(60grad))
...
int main(void){
  ...
  double V2x=-V1*cos(60*M_PI/180), V2y=V1*sin(60*M_PI/180);
  ...
  Planeta[2].Inicie(x2,y2,V2x,V2y,m2,R2); //Troyano
